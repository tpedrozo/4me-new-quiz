      ...
      <div className="w-full h-full flex md:flex-row flex-col md:pb-0 overflow-y-auto bg-amber-500">
        <div className="flex-1" onClick={() => handleSaveGender("feminino")}>
          <div className="relative w-full h-full bg-black">
            <div className="block md:hidden w-16 absolute right-10 z-40 top-10">
              <ProgressBar
                percentage={0}
                pathColor="white"
                trailColor="#1F1F1F"
            ...
            />
            <div className="absolute z-20 w-full h-full bg-[#090502]/40 hover:bg-[#090502]/0  peer transition-colors duration-500 ease-in-out" />
        ...
        <div className="flex-1" onClick={() => handleSaveGender("masculino")}>
          <div className="relative w-full h-full bg-black">
            <div className="hidden md:block w-16 absolute right-10 z-40 top-10">
              <ProgressBar
                percentage={0}
                pathColor="white"
                trailColor="#1F1F1F"
