...
export default function Home() {
  return (
    <main className="bg-[#0A0A0A] relative">
      <div className="w-full h-screen grid grid-flow-row overflow-hidden">
        <Image
        ...
        <div className="flex flex-col justify-center items-center gap-6 relative z-20 mx-auto w-full px-4">
